...
import pandas as pd
import argparse
from prompt.multi_modal_prompt import *
...
def main(model_path, input_file, output_file, image_path):
    ...
    for line in tqdm(questions):
        ...
        template_mapping = {
            "WTQ_for_TQA": wtq_multi_modal_template,
            "TABMWP_for_TQA": tabmwp_multi_modal_template,
            "TAT-QA_for_TQA": tat_qa_multi_modal_template,
            "HiTab_for_TQA": hitab_multi_modal_template,
            "FeTaQA_for_TQA": fetaqa_multi_modal_template,
            "InfoTabs_for_TFV": infotabs_multi_modal_template,
            "TabFact_for_TFV": tabfact_multi_modal_template
        }
